...
window.BOOK_TOC_DATA = [
  ...
  },
  {
    ...
    volDesc: '全站所有互動計算器、幼駒推估器、賽事戰績表、血統試算儀與多維篩選控制台直達清單',
    icon: 'fa-toolbox',
    color: '#f59e0b',
    pillarId: 'pillar-calc',
    chapters: [
      {
        chapNum: '附錄 A',
        title: '🧮 核心互動計算器與血統相性試算儀 (Interactive Calculators & Simulators)',
        secId: 'sec-calc',
        icon: 'fa-calculator',
        subsections: [
          { subNum: '§A.1', title: '🐴 幼駒能力數值成長推估計算器 (SP/Sub/成長型動態預測)', action: 'jumpToChapter', params: ['pillar-calc', 'sec-calc'] },
          { subNum: '§A.2', title: '🧬 血統相性與爆發力精算試算表 (危險度/因子/名牝活性化)', action: 'jumpToChapter', params: ['pillar-history', 'sec-compat-calc'] },
          { subNum: '§A.3', title: '🔨 年度幼駒拍賣會相馬眼試算儀 (真實價值與隱藏能力評級)', action: 'jumpToChapter', params: ['pillar-history', 'sec-auction-evaluator'] },
          { subNum: '§A.4', title: '⚡ Dosute 95/74 爆發力極限配合試算 (3周目 10 大要素精算)', action: 'jumpToBreedingExp', params: ['dosute-extreme'] },
          { subNum: '§A.5', title: '📊 系統確立血統支配率精算機 (日本5% / 世界12% 實時計算)', action: 'jumpToChapter', params: ['pillar-bloodline', 'sec-establishment-calc'] },
          { subNum: '§A.6', title: '🌐 JBIS 日本官方原站 5 代血統產駒實時檢索器 (外部資料庫直達)', action: 'openJbisWindow', params: [] }
        ]
      },
      {
        chapNum: '附錄 B',
        title: '🏆 賽事戰績紀錄儀與跑法勝率分析表 (Race Trackers & Tactics Analysis)',
        secId: 'sec-tactics-tracker',
        icon: 'fa-clipboard-list',
        subsections: [
          { subNum: '§B.1', title: '📊 實戰 13 大跑法比賽戰績紀錄儀 (橫向即時批次錄入大表)', action: 'jumpToChapter', params: ['pillar-tracker', 'sec-tactics-tracker'] },
          { subNum: '§B.2', title: '🐎 賽馬場賽道特徵與 13 大跑法適性勝率對照矩陣', action: 'jumpToChapter', params: ['pillar-race', 'sec-racecourses'] },
          { subNum: '§B.3', title: '🌍 日本國內與海外遠征 G1 賽程自動輪空安排表 (Rotation)', action: 'jumpToChapter', params: ['pillar-race', 'sec-triple-crowns'] }
        ]
      },
      {
        chapNum: '附錄 C',
        title: '🔍 全域多維度資料篩選控制台 (Universal Multi-Dimensional Filter Consoles)',
        secId: 'sec-master-lookup',
        icon: 'fa-filter',
        subsections: [
          { subNum: '§C.1', title: '🔎 1.5 萬匹全史實馬庫多維即時檢索主表 (年代/馬札/因子/適性)', action: 'jumpToChapter', params: ['pillar-history', 'sec-master-lookup'] },
          { subNum: '§C.2', title: '📅 1968~2026 全年代史實推薦名馬 15 欄大表 (年代晶片速選)', action: 'jumpToChapter', params: ['pillar-history', 'sec-yearly-recs'] },
          { subNum: '§C.3', title: '🌟 現代 51 大活躍名種公馬配種相性庫 (最高爆發力 25~45+ 篩選)', action: 'jumpToBreedingExp', params: ['modern-sires'] },
          { subNum: '§C.4', title: '🎯 史實調教全名錄與馬匹適性即時篩選器 (大成功率與冷卻期)', action: 'jumpToChapter', params: ['pillar-ability', 'sec-training'] },
          { subNum: '§C.5', title: '👑 殿堂馬異名 (稱號) 與能力加成即時篩選表 (80+ 歷史稱號)', action: 'jumpToChapter', params: ['pillar-ability', 'sec-hall-of-fame'] },
          { subNum: '§C.6', title: '🧠 後天個性 (ウマソナ) 獲得條件與克服除外條件表', action: 'jumpToChapter', params: ['pillar-ability', 'sec-umasona'] },
          { subNum: '§C.7', title: '👥 知人・牧場長・調教師・騎手全圖鑑與結婚對象篩選表', action: 'jumpToChapter', params: ['pillar-facility', 'sec-people'] },
          { subNum: '§C.8', title: '⏳ 種牡馬引退年限與 Private 搶救死線年表 (1976~2026)', action: 'jumpToChapter', params: ['pillar-history', 'sec-sires-retire-db'] },
          { subNum: '§C.9', title: '🌸 繁殖牝馬全年代引進推薦庫與可購買年分篩選', action: 'jumpToChapter', params: ['pillar-history', 'sec-broodmare-recs'] },
          { subNum: '§C.10', title: '⚡ 超級巨星名駒 (SH) 歷代全名單即時速查表', action: 'jumpToChapter', params: ['pillar-secrets', 'sec-sh-horses'] }
        ]
      },
      {
        chapNum: '附錄 D',
        title: '🧭 實戰必備神級秘籍與照抄 SOP 速查表 (Pro Tricks & Roadmap Cheat Sheets)',
        secId: 'sec-gamerch-master-db',
        icon: 'fa-compass-drafting',
        subsections: [
          { subNum: '§D.1', title: '💡 馬主實戰必備 16 大神級小技完全大百科 (一週放牧/調子重置/避坑)', action: 'jumpToGamerchModule', params: ['pro-tricks'] },
          { subNum: '§D.2', title: '🗺️ 8 大歷史年代劇本 40 年系統確立全流程路線圖 (照抄級 SOP)', action: 'jumpToBreedingExp', params: ['system-roadmap'] },
          { subNum: '§D.3', title: '👑 6 大傳奇名牝系 (Familia) 確立與名牝傳承路線圖', action: 'jumpToBreedingExp', params: ['legendary-familia'] },
          { subNum: '§D.4', title: '🎲 受胎率暗箱公式、雙胞胎仔出 ★10 鎖定與跨國零成本配種術', action: 'jumpToBreedingExp', params: ['conception-tips'] },
          { subNum: '§D.5', title: '🛡️ 御守定期升級兌換日曆表 (1月4週~4月4週 暫停SOP)', action: 'jumpToChapter', params: ['pillar-secrets', 'sec-amulets'] },
          { subNum: '§D.6', title: '🗓️ 開局初年度 52 週通關完美營運時間表 (1月~12月SOP)', action: 'jumpToChapter', params: ['pillar-secrets', 'sec-start-guide'] },
          { subNum: '§D.7', title: '🎮 Gamerch 48 篇深度攻略大百科 (四大模組速查)', action: 'jumpToChapter', params: ['pillar-history', 'sec-gamerch-master-db'] }
        ]
      }
    ]
  }
...
window.jumpToBreedingExp = function(moduleId) {
    if (typeof switchMainPillar === 'function') switchMainPillar('pillar-history');
